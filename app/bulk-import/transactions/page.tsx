...
export const metadata: Metadata = {
  title: "Bulk Import Transactions — Birhane Genet St. Mary Church",
};

export default async function BulkImportTransactionsPage() {
  await requireAuth();
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Upload historical and bulk transaction batches for accounting reconciliation."
        actions={
        ...
        <div className="lg:col-span-8">
          <Card className="p-6">
            ...
            <p className="mb-4 text-small text-text-secondary">
              Select or drop your spreadsheet containing formatted transactions records.
            </p>
            <FileDropzone />
          </Card>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:col-span-4">
          <Card className="p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {["date","accountCode","type","amount","referenceNumber","category","description"].map((h) => (
