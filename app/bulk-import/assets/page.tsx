  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Batch upload church assets, sacred vessels, vestments, and property equipment."
        actions={
        ...
        <div className="lg:col-span-8">
          <Card className="p-6">
            ...
            <p className="mb-4 text-small text-text-secondary">
              Select or drop your spreadsheet containing formatted assets records.
            </p>
            <FileDropzone />
          </Card>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:col-span-4">
          <Card className="p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {["assetName","code","category","acquisitionDate","value","location","condition"].map((h) => (
