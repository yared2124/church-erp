...
export const metadata: Metadata = {
  title: "Bulk Import Donations — Birhane Genet St. Mary Church",
};

export default async function BulkImportDonationsPage() {
  await requireAuth();
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Batch upload charitable contributions, tithes, and special pledge records."
        actions={
        ...
        <div className="lg:col-span-8">
          <Card className="p-6">
            ...
            <p className="mb-4 text-small text-text-secondary">
              Select or drop your spreadsheet containing formatted donations records.
            </p>
            <FileDropzone />
          </Card>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:col-span-4">
          <Card className="p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {["donorName","phone","amount","date","purpose","paymentMethod","receiptNumber"].map((h) => (
