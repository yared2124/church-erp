  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Upload and initialize chart of accounts, bank balances, and ledgers."
        actions={
        ...
        <div className="lg:col-span-8">
          <Card className="p-6">
            ...
            <p className="mb-4 text-small text-text-secondary">
              Select or drop your spreadsheet containing formatted accounts records.
            </p>
            <FileDropzone />
          </Card>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:col-span-4">
          <Card className="p-5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {["code","name","type","currency","openingBalance","description"].map((h) => (
