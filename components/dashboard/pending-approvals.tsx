      ...
      {isEmpty ? (
        ...
        <div className="flex flex-col gap-0.5">
          {pendingExpenses.slice(0, 2).map((e) => (
            <div key={e.id} className="flex items-center gap-2.5 rounded-md px-1.5 py-1.5 transition-colors duration-150 hover:bg-background-alt">
          ...
          {pendingCertRequests.slice(0, 2).map((c) => (
            <div key={c.id} className="flex items-center gap-2.5 rounded-md px-1.5 py-1.5 transition-colors duration-150 hover:bg-background-alt">
